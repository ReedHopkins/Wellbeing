...
<body>
	...
	<%
		...
		for (Document food : list) {
			out.print("<tr><td>" + "<a href=" +"\"/recipePage.jsp?recipeName=" + (String) food.get("title") + "\">" + (String) food.get("title") + "</a></td><td>" +  Integer.toString((int)food.get("readyInMinutes")) + "</td><td>" +  Integer.toString((int)food.get("servings")) + "</td><td>" + Double.toString((double)food.get("healthScore")) + "</td><td><img src = " + (String) food.get("image") +" style=\"height:100px;width:150px;\"></td></tr>");
		}
