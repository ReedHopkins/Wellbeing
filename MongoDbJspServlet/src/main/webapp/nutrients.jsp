...
<body>
	...
	<div id="search_form">
		...
		<div class="dropdown-menu">
			<a class="dropdown-item" href="ModelServlet?model=Nutrient&filter=macro">Macronutrients</a>
			<a class="dropdown-item" href="ModelServlet?model=Nutrient&filter=micro">Micronutrients</a>
		</div>
		<br><br>
		...
		<ul class="pagination justify-content-center">
			...
			<c:forEach items="${pageNums}" var="page">
				<li class="page-item"><a class="page-link"
					href="ModelServlet?model=Nutrient&search_term=${search_term}&page=${page}"><c:out
							value="${page}" /></a></li>
			</c:forEach>
