...
<body>
	...
	<div class="container" style="align-items:center">
		...
		<img src="../images/chicken.jpg" alt="Picture of a chicken breast" width="295" height="300">
		</div>
		<br>
		<p>Chicken is a popular option when it comes to lean protein, as it packs a considerable amount into a single serving without a lot of fat.</p>
		<h3>Nutritional Information</h1>
		<p>One skinless, boneless, cooked chicken breast (172 grams) has the following nutrition breakdown:</p>
		<ul>
			<li>Calories: 284</li>
			<li>Fat: 6.2g</li>
			<li>Sodium: 38mg</li>
