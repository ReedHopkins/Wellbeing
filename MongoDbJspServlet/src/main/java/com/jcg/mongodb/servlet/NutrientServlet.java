...
public class NutrientServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (search_term == null || "".equals(search_term)) {
			...
			String previous = "#";
			if (pageId > 1) previous = "NutrientServlet?page=" + Integer.toString(pageId - 1);	
			String next = "#";
			if (pageId < last) next = "NutrientServlet?page=" + Integer.toString(pageId + 1);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String previous = "#";
		if (pageId > 1) previous = "NutrientServlet?search_term=" + search_param + "&page=" + Integer.toString(pageId - 1);	
		String next = "#";
		if (pageId < last) next = "NutrientServlet?search_term=" + search_param + "&page=" + Integer.toString(pageId + 1);
